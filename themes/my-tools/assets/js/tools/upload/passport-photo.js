...
function init() {
    ...
    // Drag-and-drop और Clipboard पेस्ट फ़ीचर्स को इनिशियलाइज़ करें
    setupDragAndDrop();
    setupClipboardPaste();
}
...
/* ==========================================
   NEW HOOKS: DRAGENTER AUTO-OPEN WORKFLOW
   ========================================== */

/**
 * ड्रैग या पेस्ट इवेंट होने पर मौजूदा ऐड फोटो मोडल खोलता है
 */
...
/**
 * जैसे ही फ़ाइल विंडो में ड्रैग होगी, छोड़ना (Drop) शुरू होने से पहले ही मोडल खुल जाएगा
 */
function setupDragAndDrop() {
    // ब्राउज़र की डिफ़ॉल्ट नेविगेशन सेटिंग्स को रोकने के लिए प्रिवेंट रूटीन
    ...
    // जैसे ही फ़ाइल को स्क्रीन पर लाया जाएगा (छोड़ने से पहले), मोडल तुरंत खुल जाएगा
    window.addEventListener('dragenter', (e) => {
        e.preventDefault();
        
        // चेक करें कि ड्रैग की जा रही आइटम में कोई फ़ाइल है या नहीं
...
/**
 * क्लिपबोर्ड से इमेज पेस्ट (Ctrl+V) डिटेक्ट होने पर मोडल खोलता है
 */
