...
function addField(containerId){
    ...
    row.innerHTML = `
        ...
        <input type="text" class="field-label" placeholder="फ़ील्ड का नाम">
...
async function clearFormData(){
    if(!confirm("क्या आप निश्चित हैं कि आप पूरा फ़ॉर्म साफ़ करना चाहते हैं?")) return;
    await clearPhoto();
...
function fillExampleBiodata(){
    ...
    document.getElementById("aboutSelect").value = "पारंपरिक एवं आधुनिक विचारों का संगम";
    document.getElementById("height").value = "5 फीट 8 इंच";
    document.getElementById("weight").value = "70 किलोग्राम";
    document.getElementById("complexion").value = "गोरा";
    document.getElementById("religion").value = "हिन्दू";
    ...
    document.getElementById("manglik").value = "नहीं";
    ...
    document.getElementById("motherOccupation").value = "गृहिणी";
