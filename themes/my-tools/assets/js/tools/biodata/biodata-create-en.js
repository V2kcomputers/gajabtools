...
async function handleUploadedImage(data) {
    ...
    if (data.blob) {
        ...
        if (target === "photo") {
            ...
            if (txt) txt.textContent = "Replace ✏️";
        }
...
function fillExampleBiodata(){
    ...
    document.getElementById("placeBirth").value = "Bhopal, Madhya Pradesh";
    document.getElementById("aboutSelect").value = "Traditional with Modern Values";
    document.getElementById("height").value = "5 ft 8 in";
    ...
    document.getElementById("caste").value = "Brahmin";
    document.getElementById("gotra").value = "Bharadwaj";
    document.getElementById("rashi").value = "Mesh (Aries)";
    document.getElementById("nakshatra").value = "Ashwini";
    document.getElementById("manglik").value = "No";
    ...
    document.getElementById("fatherName").value = "Mahesh Sharma";
    document.getElementById("fatherOccupation").value = "Businessman";
    document.getElementById("motherName").value = "Sunita Sharma";
    document.getElementById("motherOccupation").value = "Homemaker";
    document.getElementById("siblings").value = "1 Brother";
    document.getElementById("mobile").value = "9876543210";
    document.getElementById("address").value = "Bhopal, Madhya Pradesh";

    saveDraft();
    alert("Example data has been filled successfully.");
}
